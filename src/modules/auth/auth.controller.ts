...
router.patch("/verify-forgot-password", validation(validators.verifyForgotPasswordCode), authService.sendForgotPasswordCode);
router.patch("/reset-forgot-password", validation(validators.ResetForgotPasswordCode), authService.resetForgotPassword);
