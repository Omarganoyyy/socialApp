...
import { GenderEnum, HUserDocument, RoleEnum, UserModel } from "../../DB/model/user.model";
...
export class UserService {
    ...
    allUsers =async (args: { name: string; gender: GenderEnum;authUser:HUserDocument }):Promise<HUserDocument[]> => {
