...
export class UserResolver {
  ...
  allUsers = async(parent: unknown, args: { gender: GenderEnum;authUser:HUserDocument }): Promise<HUserDocument> => {
    return await this.userModel.find({filter:{gender:args.gender}})
  };
