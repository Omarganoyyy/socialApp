import {DeleteObjectCommand, DeleteObjectCommandOutput, DeleteObjectsCommand, DeleteObjectsCommandOutput, GetObjectCommand, GetObjectCommandOutput, ListObjectsV2Command, ObjectCannedACL, PutObjectAclCommand, PutObjectCommand, S3Client} from '@aws-sdk/client-s3'
...
export const createPreSigneUploadLink=async ({
    Bucket=process.env.AWS_BUCKET_NAME as string,
    path="general",
