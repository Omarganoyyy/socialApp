...
import { createGetPreSignedLink, deleteFile, deleteFiles, deleteFolderByPrefix, getFile, listDirectoryFiles } from "./utils/multer/s3.config"
import {router as authRouter} from './modules/auth'
import {router as userRouter} from './modules/user'
import {router as postRouter} from './modules/post'
...
app.get("/upload/*path",async (req:Request,res:Response):Promise<void>=>
{
    ...
    return await createS3WriteStreamPipe(s3Response.Body as NodeJS.ReadableStream,
        res
    )
})
