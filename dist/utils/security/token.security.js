...
exports.createRevokeToken = exports.decodeToken = exports.createLoginCrendentials = exports.getSignatures = exports.detectSignatureLevel = exports.verifyToken = exports.generateToken = exports.LogoutEnum = exports.TokenEnum = exports.SignatureLevelEnum = void 0;
...
const generateToken = async ({ payload, secret = process.env.ACCESS_USER_TOKEN_SECURITY, options = { expiresIn: Number(process.env.ACCESS_TOKEN_EXPIRES_IN) } }) => {
