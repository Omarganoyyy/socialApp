...
router.patch("/verify-forgot-password", (0, validation_middleware_1.validation)(validators.verifyForgotPasswordCode), auth_service_1.default.sendForgotPasswordCode);
router.patch("/reset-forgot-password", (0, validation_middleware_1.validation)(validators.ResetForgotPasswordCode), auth_service_1.default.resetForgotPassword);
